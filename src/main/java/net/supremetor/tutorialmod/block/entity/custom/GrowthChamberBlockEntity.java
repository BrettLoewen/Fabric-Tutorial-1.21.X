...
import net.supremetor.tutorialmod.recipe.GrowthChamberRecipeInput;
import net.supremetor.tutorialmod.recipe.ModRecipes;
import net.supremetor.tutorialmod.screen.custom.GrowthChamberScreenHandler;
...
public class GrowthChamberBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory<BlockPos>, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block.tutorial-mod.growth_chamber");
    }
